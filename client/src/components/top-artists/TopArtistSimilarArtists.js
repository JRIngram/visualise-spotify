...
class TopArtistSimilarArtists extends Component {
    ...
    createNewPlaylist = (numOfArtists, numOfSongs) => {
        ...
        this.props.spotifyWebApi.createPlaylist(this.props.userId, { name: playlistName, description: playlistDescription })
            .then((response) => {
                ...
                uploadPlaylistImage(this.props.spotifyWebApi, response.id, "similar-artists-playlist-cover.jpg");
    ...
    populatePlaylist = (playlistId, numOfArtists, numOfSongs) => {
        ...
        getTopTracksForArtists(similarArtists, numOfSongs, this.props.spotifyWebApi)
            .then((tracks) => {
    ...
    render() {
        return (
            <div>
                <SimilarArtistsModal createNewPlaylist={this.createNewPlaylist} />
